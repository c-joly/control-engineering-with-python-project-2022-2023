...
Your team: group number 0

  - Student 1: Cyril JOLY `c-joly` (given name + first name + `github user name`, for example Sébastien Boisgérault `boisgera`)

  - Student 2: Sébastien Boisgérault `boisgera` (given name + first name + `github user name`, for example Sébastien Boisgérault `boisgera`)
